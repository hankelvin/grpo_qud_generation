...
This repository holds the data, code and models in the paper, "Generating Questions Under Discussion with Reinforcement Learning using Ranking and Scoring for Reward and Evaluation".
