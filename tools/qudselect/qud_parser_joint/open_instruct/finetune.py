...
# HOME = '/home/khan/synalp_me/'
HOME = '/workspace'
with open(f'{HOME}/agentic_qud/hf_token.txt', encoding = 'utf-8') as f:
    hf_token = f.read().strip()
print('hf_token')
login(hf_token)
os.environ['HF_HOME'] = f'{HOME}/llm_models'
os.environ['HF_HUB_CACHE'] = f'{HOME}/llm_models/hub'
### CHANGE END ###
...
def main():
    ...
    if args.model_name_or_path:
        ### CHANGE START ###
        load_in_8_bit = False
        if '-3B' not in args.model_name_or_path:
            load_in_8_bit = True
        ### CHANGE END ###
